...
export function Like() {
  ...
  return <div className="placement"
    ...
    <div className="heart">
      <svg className={addedToWishlist ? "added_to_wishlist" : "not_added_to_wishlist" } version="1.1" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier"><title>heart</title>
          <path
...
export function LinkButton({ linkTo }: { linkTo: string }) {
  ...
  return <>
    <Link to={linkTo}
          className={linkTo === '/' ?
              "link-offset-2 text-primary-emphasis" : "link-offset-2 fs-3 ink-underline-light text-light"}>
      {actionName}
    </Link>
  </>
}
